 ...
 */
export function processData(mainRows, diffRows) {
...
export function computeKPIs(allData, shortageData, diffRows) {
  ...
  const clearedCases = shortageData.filter(d => (d.scanShort > 0 || d.scanOver > 0) && d.r008).length;
